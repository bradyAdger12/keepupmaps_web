...
export type DeleteMapMutation = { __typename?: 'mutation_root', delete_maps_by_pk?: { __typename?: 'maps', id: any } | null };

export type FetchMapQueryVariables = Exact<{
  mapId: Scalars['uuid']['input'];
}>;


export type FetchMapQuery = { __typename?: 'query_root', maps_by_pk?: { __typename?: 'maps', name: string, id: any, created_at: any, updated_at: any } | null };
...
export type CreateTerritoryMutation = { __typename?: 'mutation_root', insert_territories_one?: { __typename?: 'territories', id: any } | null };
...
export const FetchMapDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FetchMap"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mapId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"maps_by_pk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mapId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]}}]} as unknown as DocumentNode<FetchMapQuery, FetchMapQueryVariables>;
